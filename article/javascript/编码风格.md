...
以下风格都会补充对应的 eslint 规则(如果有且被我发现的话 😑
...
## 不使用[魔术数字(Magic Number)](<https://en.wikipedia.org/wiki/Magic_number_(programming)>)

魔术数字可以是指硬编码在代码里的具体数值(如 “10”“123” 等以数字直接写出的值);
...
## 避免在 switch 的 case 中出现词法声明(let, const, function, class)
